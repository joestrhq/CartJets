...
public class CartJetsModel {
  ...
  @DatabaseField private UUID buttonLocationWorldUuid;
  @DatabaseField private double buttonLocationX;
  @DatabaseField private double buttonLocationY;
  @DatabaseField private double buttonLocationZ;
  @DatabaseField private float buttonLocationPitch;
  @DatabaseField private float buttonLocationYaw;

  @DatabaseField private UUID minecartSpawningLocationWorldUuid;
  @DatabaseField private double minecartSpawningLocationX;
  @DatabaseField private double minecartSpawningLocationY;
  @DatabaseField private double minecartSpawningLocationZ;
  @DatabaseField private float minecartSpawningLocationPitch;
  @DatabaseField private float minecartSpawningLocationYaw;

  public CartJetsModel() {}

  public CartJetsModel(
      String name,
      UUID buttonLocationWorldUuid,
      double buttonLocationX,
      double buttonLocationY,
      double buttonLocationZ,
      float buttonLocationPitch,
      float buttonLocationYaw,
      UUID minecartSpawningLocationWorldUuid,
      double minecartSpawningLocationX,
      double minecartSpawningLocationY,
      double minecartSpawningLocationZ,
      float minecartSpawningLocationPitch,
      float minecartSpawningLocationYaw) {
    this.name = name;
