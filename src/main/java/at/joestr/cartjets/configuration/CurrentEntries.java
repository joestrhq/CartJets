...
public enum CurrentEntries {
  ...
  CONF_UPDATER_DOWNLOADTOPLUGINUPDATEFOLDER(
      "updater.downloadToPluginUpdateFolder", new int[] {1, 2}),
  ...
  LANG_CMD_CARTJETS_SETUPWIZARD_BUTTON_INSTRUCTION(
      "commands.cartjets-setupwizard.button.instruction", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_BUTTON_SUCCESS(
      "commands.cartjets-setupwizard.button.success", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_BUTTON_OVERLAPPING(
      "commands.cartjets-setupwizard.button.overlapping", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_RAIL_INSTRUCTION(
      "commands.cartjets-setupwizard.rail.instruction", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_RAIL_SUCCESS(
      "commands.cartjets-setupwizard.rail.success", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_NAME_ANVIL_GUI_TEXT(
      "commands.cartjets-setupwizard.name.anvilgui_text", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_NAME_PLACEHOLDER(
      "commands.cartjets-setupwizard.name.placeholder", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_NAME_DUPLICATE(
      "commands.cartjets-setupwizard.name.duplicate", new int[] {1, 2}),
  LANG_CMD_CARTJETS_SETUPWIZARD_NAME_SUCCESS(
      "commands.cartjets-setupwizard.name.success", new int[] {1, 2}),
  ...
  public static CurrentEntries find(String text) {
    Optional<CurrentEntries> result =
        Arrays.asList(values()).stream()
            .filter(currentEntry -> currentEntry.toString().equalsIgnoreCase(text))
            .findFirst();
    if (result.isPresent()) {
      return result.get();
    }
